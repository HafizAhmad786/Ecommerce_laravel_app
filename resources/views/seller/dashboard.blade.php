            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="modal fade " id="createProductModel" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('createProduct') }}" method="post" id="productModel"
                                        class="m-4" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-6">
                                            <label for="Product Image" class="form-label">Product Image</label>
                                            <input type="file" class="form-control"
                                                value="{{ old('product_image') }}" id="product_image" name="image"
                                                placeholder="Choose your image" autofocus />
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <input type="number" class="form-control" id="product_price"
                                                value="{{ old('product_price') }}" name="product_price"
